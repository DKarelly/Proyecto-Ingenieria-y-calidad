...
--
-- Table structure for table `AUDITORIA_ARCHIVO`
--
...
CREATE TABLE `AUDITORIA_ARCHIVO` (
  ...
  CONSTRAINT `AUDITORIA_ARCHIVO_ibfk_1` FOREIGN KEY (`id_auditoria`) REFERENCES `AUDITORIA` (`id_auditoria`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `AUDITORIA_ARCHIVO`
--
...
--
-- Table structure for table `BLOQUEO_PROGRAMACION`
--

DROP TABLE IF EXISTS `BLOQUEO_PROGRAMACION`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `BLOQUEO_PROGRAMACION`
--
...
INSERT INTO `EMPLEADO` VALUES (1,'Karelly','Garcia Inoñan','72658837','Femenino','Activo',3,1,140312,1),(2,'Mauricio','Chero','73109345','Masculino','Activo',1,2,140101,2),(3,'Manu','Fiestas','78905642','Masculino','Activo',2,3,130504,2),(4,'María','Salazar Rivas','75648921','Femenino','Activo',6,2,140105,4),(5,'Juan','Cáceres Torres','74859632','Masculino','Activo',7,3,20903,4),(6,'Carlos','Pérez Mendoza','72563148','Masculino','Activo',8,4,140201,1),(7,'Ana','Gómez Huamán','73924856','Femenino','Activo',9,5,131101,2),(17,'Jasson','Puican (Administrador)','72780865','Masculino','ACTIVO',21,1,140312,1);
...
INSERT INTO `PACIENTE` VALUES (1,'Dana','Garcia','17602994',NULL,'2007-11-02',4,140312),(2,'Paciente','1','14785569',NULL,'2025-09-17',5,140301),(3,'Lucía','Rojas Pérez','74569812','Femenino','1992-04-15',10,140105),(4,'Fernando','López Ramírez','73214567','Masculino','1988-09-22',11,140312),(5,'Karina','Mendoza Torres','75623145','Femenino','1995-11-10',12,140201),(6,'David','Silva Gutiérrez','74891236','Masculino','1990-07-05',13,140101),(7,'Rocío','Torres Campos','76253418','Femenino','1985-01-25',14,130504),(8,'Andrés','Pacheco Ruiz','75361248','Masculino','1998-03-19',15,131101),(9,'María','García León','76984512','Femenino','2000-06-30',16,20903),(10,'Luis','Vargas Moreno','74123689','Masculino','1993-08-14',17,140105),(13,'juan','diez','12236533',NULL,'2004-05-27',22,150201),(14,'Matias','Puican','15687792',NULL,'2025-10-07',23,60101);
...
--
-- Table structure for table `RECURSO_ARCHIVO`
--

DROP TABLE IF EXISTS `RECURSO_ARCHIVO`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `RECURSO_ARCHIVO` (
  `id_archivo` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `RECURSO_ARCHIVO`
--
...
INSERT INTO `REPORTE` VALUES (31,'REP-20251031105500-1787','dd','Auditoría','dd',NULL,'Pendiente','2025-10-31 10:55:01',8,2,NULL,NULL);
/*!40000 ALTER TABLE `REPORTE` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `REPORTE_ARCHIVO`
--

DROP TABLE IF EXISTS `REPORTE_ARCHIVO`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `REPORTE_ARCHIVO`
--
...
INSERT INTO `SERVICIO` VALUES (1,'Pediatría','Atención médica personalizada en diversas especialidades médicas.','Activo',1,2),(2,'Cirugía General','Procedimientos quirúrgicos enfocados en el tratamiento de patologías abdominales, de piel, tejidos blandos y hernias.','Activo',2,17),(3,'Hematología','Análisis de sangre para evaluación del estado general de salud.','Activo',6,NULL),(4,'Rayos X','Servicios de diagnóstico por imágenes mediante rayos X y tomografías.','Activo',3,NULL),(5,'Ecografía 4D/5D/6D','Servicio de ecografía avanzada para control médico y gestacional.','Activo',3,3),(6,'Banco de Sangre','Procesamiento y almacenamiento de sangre y hemoderivados para transfusiones.','Activo',4,NULL),(7,'Central de Esterilización','Área encargada de la esterilización de materiales e instrumentos médicos.','Activo',4,NULL),(8,'Farmacia','Dispensación y venta de medicamentos para pacientes hospitalizados y externos.','Activo',5,NULL),(10,'Tomografía','Servicios de diagnóstico por tomografías.','Activo',3,NULL),(11,'Cardiología','Especialidad encargada del diagnóstico, tratamiento y prevención de las enfermedades del corazón y del sistema cardiovascular.','Activo',1,4),(12,'Endocrinología','Se ocupa del estudio, diagnóstico y tratamiento de los trastornos hormonales y metabólicos, como la diabetes y los problemas tiroideos.','Activo',1,11),(13,'Gastroenterología','Atiende las enfermedades del aparato digestivo, incluyendo estómago, hígado, páncreas e intestinos.','Activo',1,12),(14,'Ginecología','Brinda atención integral a la salud reproductiva y ginecológica de la mujer, desde la adolescencia hasta la menopausia.','Activo',1,3),(15,'Dermatología','Especialidad médica enfocada en el diagnóstico y tratamiento de enfermedades de la piel, cabello y uñas.','Activo',1,5),(16,'Neurología','Se dedica al estudio, diagnóstico y tratamiento de los trastornos del sistema nervioso central y periférico.','Activo',1,8),(17,'Otorrinolaringología','Se encarga del diagnóstico y tratamiento de enfermedades del oído, nariz, garganta y estructuras relacionadas de cabeza y cuello.','Activo',1,13),(18,'Traumatología','Trata lesiones y enfermedades del sistema musculoesquelético, como huesos, articulaciones, ligamentos y tendones.','Activo',1,NULL),(19,'Urología','Especialidad médica que se ocupa del sistema urinario en ambos sexos y del aparato reproductor masculino.','Activo',1,14),(20,'Bioquímica Clínica','Pruebas para medir glucosa, colesterol, función renal y hepática.','Activo',6,NULL),(21,'Inmunología','Pruebas inmunológicas y detección de anticuerpos.','Activo',6,NULL),(22,'Cirugía Ginecológica','Intervenciones quirúrgicas relacionadas con el sistema reproductor femenino, como histerectomía o laparoscopía ginecológica.','Activo',2,3),(23,'Cirugía Ortopédica y Traumatológica','Cirugías de huesos, articulaciones, tendones y ligamentos para tratar fracturas y lesiones musculoesqueléticas.','Activo',2,NULL),(24,'Cirugía Urológica','Procedimientos quirúrgicos del sistema urinario y aparato reproductor masculino.','Activo',2,14),(25,'Cirugía Plástica','Procedimientos estéticos y reconstructivos destinados a mejorar la apariencia o restaurar la funcionalidad de tejidos y estructuras corporales.','Activo',2,15),(26,'Neurocirugía','Procedimientos quirúrgicos que tratan enfermedades del cerebro, médula espinal y sistema nervioso periférico.','Activo',2,8),(27,'Cirugía Gastrointestinal','Cirugías del aparato digestivo que incluyen estómago, intestinos, hígado, vesícula biliar y páncreas.','Activo',2,12);
...
INSERT INTO `TIPO_SERVICIO` VALUES (1,'Servicios de Consulta','Atención médica en consultorios externos de diversas especialidades.'),(2,'Procedimientos Quirúrgicos','Intervenciones quirúrgicas y atención en centro quirúrgico.'),(3,'Diagnóstico e Imagenología','Servicios de laboratorio clínico, rayos X, ecografía y tomografía.'),(4,'Banco de Sangre y Esterilización','Procesamiento y manejo de sangre, además de la central de esterilización.'),(5,'Farmacia','Atención y dispensación de medicamentos dentro de la clínica.'),(6,'Laboratorio Clínico','Realización de análisis y pruebas de laboratorio para diagnóstico.');
...
-- Dump completed on 2025-10-31 12:33:03
